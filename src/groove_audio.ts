...
function notesPerMeasureInFullSizeArray(is_triplet_division: boolean, timeSig: TimeSignature): number {
...
function getNoteScaler(notes_per_measure: number, timeSig: TimeSignature): number {
...
function noteGroupingSize(notes_per_measure: number, timeSig: TimeSignature): number {
...
(globalThis as any).create_note_mapping_array_for_highlighting = create_note_mapping_array_for_highlighting;
(globalThis as any).figure_out_sticking_count_for_index = figure_out_sticking_count_for_index;
(globalThis as any).convert_sticking_counts_to_actual_counts = convert_sticking_counts_to_actual_counts;
